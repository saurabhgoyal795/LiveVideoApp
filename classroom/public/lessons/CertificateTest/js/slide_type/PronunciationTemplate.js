...
function SlideType_PronunciationTemplate_Function(sectionId,SlideType_Data){
	...
	for(var i=0;i<options.length;i++){
		...
		html += '<div isCorrect="'+isCorrect+'" onclick="$(this).find(\'audio\')[0].play();" class="SlideType_Choose_2_without_Top_Photo_Div SlideType_Choose_2_without_Top_Photo_Div_UnChecked option'+(i+1)+'">'
							+'<table style="width: 100%; height: 100%;">'
								+'<tr>'
									...
									+'<td class="SlideType_Choose_2_without_Top_Photo_TextTD SlideType_Choose_2_without_Top_Photo_TextTD_UnChecked">'
										+'<div class="SlideType_Choose_2_without_Top_Photo_Text SlideType_Choose_2_without_Top_Photo_Text_UnChecked"><img src="img/ic_volume_up_black_24dp_2x.png" style="margin:auto;width: 40px;"/><br><div style="font-size:24px;">Option'+(i+1)+'</div></div><audio style="display:none;"><source src="https://storage.cloud.google.com/he_web_assets/downloadable_lessons/'+courseId+'/audios/'+options[i][0]+'"></source></audio></td>'
								+'</tr>'
							+'</table>'
						+'</div>';	
	}
