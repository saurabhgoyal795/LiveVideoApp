...
//    verbose_exec('print "Welcome to PyPy.js!\\n";import sys;print "Python v"+sys.version',init_run=true);
});
...
function initiateEditor(){
    ...
    jqconsole.Write('Loading...', 'jqconsole-output');
    verbose_exec('print "Welcome to HelloLearner!\\n";',init_run=true);
}
